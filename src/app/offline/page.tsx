...
export default function OfflinePage() {
  return (
    <main className="build-state">
      ...
      <p>
        Your saved captures and records are safe on the server. Slipwell keeps your data online
        rather than on this device, so the app needs a connection to show it.
      </p>
      <div className="build-state-rule" />
      <p className="text-sm text-[var(--ink-muted)]">
        A capture you typed but did not send is not stored yet. Keep this tab open until you
        reconnect, or copy the text somewhere safe before closing it.
      </p>
