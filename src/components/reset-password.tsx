...
export function ResetPassword() {
  ...
  return (
    <main className="mx-auto flex min-h-[100dvh] max-w-xl items-center px-5">
      <section className="w-full rounded-lg border border-[var(--line)] bg-[var(--surface)] p-8 shadow-[0_20px_60px_rgba(26,43,34,0.08)] sm:p-10">
        <p className="text-sm font-semibold tracking-[0.18em] text-[var(--accent)] uppercase">
          Slipwell
        </p>
        <h1 className="mt-5 text-4xl font-semibold tracking-tight">Choose a new password.</h1>
        <p className="mt-4 leading-7 text-[var(--ink-muted)]">
          After saving it, you can continue where you left off.
        </p>
