...
export function DraggableTaskCard({ task, onCommand, today, data }: { task: TodayTask; onCommand: WorkspaceCommandFn; today: string; data: WorkspaceData }) {
...
export function PriorityDropZone({ tasks, onCommand, today, data }: { tasks: TodayTask[]; onCommand: WorkspaceCommandFn; today: string; data: WorkspaceData }) {
...
export function TodayBoard({ topThree, dueToday, onCommand, today, data }: { topThree: TodayTask[]; dueToday: TodayTask[]; onCommand: WorkspaceCommandFn; today: string; data: WorkspaceData }) {
