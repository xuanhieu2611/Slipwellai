...
export function TaskCard({ task, onCommand, today, data, showTopThree = true, dragHandle }: { task: WorkspaceData["tasks"][number]; onCommand: WorkspaceCommandFn; today: string; data: WorkspaceData; showTopThree?: boolean; dragHandle?: ReactNode }) {
