...
export function ProjectEditForm({
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      await onCommand({
        ...
        startOn: formValue(form, "startOn"),
        targetOn: formValue(form, "targetOn"),
  ...
  return (
    <form className="form-grid" onSubmit={submit}>
      ...
      <DomainSelect domains={data.domains} defaultValue={project.domain_id ?? ""} />
      <PersonSelect people={data.people} defaultValue={project.person_id ?? ""} />
      ...
      <label className="field-label">
        ...
        <input
          ...
          type="date"
          name="targetOn"
          defaultValue={project.target_on ?? ""}
        />
      </label>
      <label className="field-label">
        ...
        <input
          ...
          defaultValue={project.slipping_cadence_days ?? ""}
        />
    ...
    <form className="form-grid" onSubmit={submit}>
      <label className="field-label form-span">
        ...
        <input
          ...
          required
          maxLength={160}
          placeholder="Launch the September client report"
        />
      </label>
      <label className="field-label form-span">
        <span>Description</span>
      ...
      <PersonSelect people={data.people} />
      <label className="field-label">
        <span>Start date</span>
        <input className="field-base" type="date" name="startOn" />
      </label>
      <label className="field-label">
        <span>Target date</span>
        <input className="field-base" type="date" name="targetOn" />
      </label>
      <label className="field-label">
        <span>Attention cadence (days)</span>
        <input
