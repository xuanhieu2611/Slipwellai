...
import { unmatchedNames, type DestinationCatalog, type ResolvedDestination } from "@/lib/proposals/destinations";
...
export function destinationSelection(draft: DestinationDraft, resolved: ResolvedDestination): DestinationSelection {
...
export function destinationNotes(resolved: ResolvedDestination, catalog: DestinationCatalog): string[] {
  const notes: string[] = [];
