...
describe("core Slipping explanations", () => {
  ...
  it("uses meaningful activity rather than an arbitrary update timestamp", () => {
    const signal = coreSlippingExplanation(
      {
        entityType: "project",
        entityId: "project",
        title: "Launch",
        createdAt: "2026-08-01T12:00:00Z",
        lastMeaningfulAttention: "2026-08-15T12:00:00Z",
        cadenceDays: 7,
      },
      "America/Vancouver",
      now,
  ...
  it("explains the cadence and escalates an overdue high-priority task", () => {
    const signal = coreSlippingExplanation(
      {
        ...
        title: "Send report",
        createdAt: "2026-08-01T12:00:00Z",
        lastMeaningfulAttention: "2026-08-02T12:00:00Z",
        dueOn: "2026-08-10",
        priority: 3,
        cadenceDays: 14,
      },
    ...
    expect(signal).toEqual({
      severity: "urgent",
      reason:
        "No meaningful attention for 18 days; your expected cadence for this task is 14 days. It was due 2026-08-10.",
    });
  });
    ...
    const signal = coreSlippingExplanation(
      {
        ...
        lastMeaningfulAttention: "2026-10-25T12:00:00Z",
        dueOn: "2026-10-31",
        cadenceDays: 14,
      },
      "America/Vancouver",
