...
- [ ] Partial: distinguish due, scheduled, defer/until, and limited recurrence semantics in storage and UI, including from an accepted or manually filed capture; timezone-boundary integration coverage remains open.
