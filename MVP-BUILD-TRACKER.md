...
- [ ] Partial: implement a unified, account-scoped working-prototype search across loaded tasks, projects, domains, people, notes, and captures. Postgres full-text indexing, retainer inclusion, and performance verification remain open. Record type/status/domain/project/person/date-range filters are now implemented (see below).
